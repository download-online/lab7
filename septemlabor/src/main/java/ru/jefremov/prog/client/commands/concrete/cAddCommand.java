 ...
 */
public class cAddCommand extends ClientAbstractCommand<TicketArgumentedState, IntegerResult> {
    private final TicketArgument arg1 = new TicketArgument("Ticket", this);
    public cAddCommand(String word, ClientCommandManager manager) {
        super(word, manager, true,false);
    }

    public cAddCommand(String word, ClientCommandManager manager, String description) {
    ...
    protected void runInterpretation(IntegerResult result) {
        ...
        } else Printer.println("Failed to add ticket.");
    }
}
